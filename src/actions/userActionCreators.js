...
export const loginUserSuccess = (payload: Object) => ({
  type: ACTION.LOG_IN_USER_SUCCESS,
  payload,
});
export const loginUserFailure = () => ({ type: ACTION.LOG_IN_USER_FAILURE });

export const loginUser = (obj: Object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (!response.success) return dispatch(loginUserFailure());
...
export const isAuthenticatedRequest = () => ({
  type: ACTION.IS_AUTHENTICATED_REQUEST,
});
export const isAuthenticatedSuccess = (payload: string) => ({
  type: ACTION.IS_AUTHENTICATED_SUCCESS,
  payload,
});
export const isAuthenticatedFailure = () => ({
  type: ACTION.IS_AUTHENTICATED_FAILURE,
});

export const isAuthenticated = () => (dispatch: Function) => {
...
export const loadUserDataRequest = () => ({
  type: ACTION.LOAD_USER_DATA_REQUEST,
});
export const loadUserDataSuccess = (payload: Object) => ({
  type: ACTION.LOAD_USER_DATA_SUCCESS,
  payload,
});
export const loadUserDataFailure = () => ({
  type: ACTION.LOAD_USER_DATA_FAILURE,
});

export const loadUserData = (id: string) => async (dispatch: Function) => {
...
export const updateUserDataSuccess = (payload: Object) => ({
  type: ACTION.UPDATE_USER_DATA_SUCCESS,
  payload,
});
export const updateUserDataFailure = () => ({
  type: ACTION.UPDATE_USER_DATA_FAILURE,
});

export const updateUserData = (obj: Object) => async (dispatch: Function) => {
