...
'CREATE_POST_DATA_REQUEST' | 'CREATE_POST_DATA_SUCCESS' | 'CREATE_POST_DATA_FAILURE' |
'UPDATE_POST_DATA_REQUEST' | 'UPDATE_POST_DATA_SUCCESS' | 'UPDATE_POST_DATA_FAILURE' |
'REMOVE_POST_DATA_REQUEST' | 'REMOVE_POST_DATA_SUCCESS' | 'REMOVE_POST_DATA_FAILURE' |
...
'CREATE_PROJECT_DATA_REQUEST' | 'CREATE_PROJECT_DATA_SUCCESS' | 'CREATE_PROJECT_DATA_FAILURE' |
'UPDATE_PROJECT_DATA_REQUEST' | 'UPDATE_PROJECT_DATA_SUCCESS' | 'UPDATE_PROJECT_DATA_FAILURE' |
'REMOVE_PROJECT_DATA_REQUEST' | 'REMOVE_PROJECT_DATA_SUCCESS' | 'REMOVE_PROJECT_DATA_FAILURE' |
'LOAD_PROJECT_ITEM_REQUEST' | 'LOAD_PROJECT_ITEM_SUCCESS' | 'LOAD_PROJECT_ITEM_FAILURE' | 'UPDATE_PROJECT_ITEM_SUCCESS';
...
export type Action = 
  ...
  ActionT<'CREATE_PROJECT_DATA_REQUEST', ''> |
  ActionT<'CREATE_PROJECT_DATA_SUCCESS', Data> |
  ActionT<'CREATE_PROJECT_DATA_FAILURE', ''> |
  ActionT<'UPDATE_PROJECT_DATA_REQUEST', ''> |
  ActionT<'UPDATE_PROJECT_DATA_SUCCESS', Data> |
  ActionT<'UPDATE_PROJECT_DATA_FAILURE', ''> |
  ActionT<'REMOVE_PROJECT_DATA_REQUEST', ''> |
  ActionT<'REMOVE_PROJECT_DATA_SUCCESS', Data> |
  ActionT<'REMOVE_PROJECT_DATA_FAILURE', ''> |
  ActionT<'LOAD_PROJECT_ITEM_REQUEST', ''> |
  ActionT<'LOAD_PROJECT_ITEM_SUCCESS', Item> |
  ActionT<'LOAD_PROJECT_ITEM_FAILURE', ''> |
  ActionT<'UPDATE_PROJECT_ITEM_SUCCESS', ''>;